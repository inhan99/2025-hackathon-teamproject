...
const ShareBoardPage = () => {
  ...
  const loadPosts = (page = 0) => {
    ...
    // 페이징 API 시도
    fetchPostsByTypeWithPaging("share", page, pageSize)
      .then((res) => {
    ...
    <div className="min-h-screen bg-gray-50 pt-52 max-w-[1440px] mx-auto py-4 bg-[#ffffff] border-l-4 border-r-4">
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">나눔게시판</h1>
            <p className="text-gray-600 mt-1">물건을 나누고 받는 공간</p>
          </div>
          {isLoggedIn && (
            <Link
              to="/boards/share/write"
