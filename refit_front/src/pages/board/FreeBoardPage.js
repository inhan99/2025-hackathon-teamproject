...
const FreeBoardPage = () => {
  ...
  const loadPosts = (page = 0) => {
    ...
    // 페이징 API 시도
    fetchPostsByTypeWithPaging("freedom", page, pageSize)
      .then((res) => {
      ...
      .catch((error) => {
        ...
        return fetchPostsByType("freedom");
      })
      .then((res) => {
        if (res && res.data) {
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">자유롭게 이야기를 나누는 공간</p>
          </div>
          {isLoggedIn && (
            <Link
              to="/boards/freedom/write"
        ...
        <div className="space-y-4">
          {posts.map((post, index) => (
            ...
            >
              <Link
                to={`/boards/freedom/post/${post.id}`}
