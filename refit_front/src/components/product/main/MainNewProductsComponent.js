...
const MainNewProductsComponent = () => {
  ...
  const {
    ...
    loading,
    reset,
  } = useInfiniteScroll(getNewProducts, {}, 10, "new-products");
    ...
    <section className="py-4 bg-[#ffffff] border-l-4 border-r-4">
      <div className="max-w-[1440px] mx-auto">
        <h2 className="text-2xl font-bold mb-6 text-green-600 px-6">
          NEW Items <br />
          <p className="text-gray-600">새로운 아이템</p>
        </h2>
...
export default MainNewProductsComponent;
